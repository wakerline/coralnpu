...
#ifndef __VCS_IMPORT_DPI_STUB_read_section
#define __VCS_IMPORT_DPI_STUB_read_section
__attribute__((weak)) char read_section(/* INPUT */long long A_1, const /* INOUT */svOpenArrayHandle A_2)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static char (*_vcs_dpi_fp_)(/* INPUT */long long A_1, const /* INOUT */svOpenArrayHandle A_2) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (char (*)(long long A_1, const svOpenArrayHandle A_2)) dlsym(RTLD_NEXT, "read_section");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        return _vcs_dpi_fp_(A_1, A_2);
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "read_section");
        return 0;
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_read_section */
