// ============================================================================
// RvviTrace.scala — RVVI (RISC-V Verification Interface) 验证跟踪
//
// 将退役缓冲区中的指令信息转换为 RVVI 标准格式供外部验证工具使用:
//   GenerateRvviTraceSource — 动态拼接 SystemVerilog 黑盒 wrapper 字符串
//   RvviTraceBlackBox      — 含内联 SV 的 Chisel BlackBox (addResource + setInline)
//   RvviTrace              — 读取 RetirementBufferDebugIO + CsrTraceIO,
//                             转换为 PC/指令/标量写回/浮点写回/向量写回/CSR变化
// ============================================================================
...
/** 动态生成 RVVI 黑盒的 SystemVerilog wrapper 字符串 */
