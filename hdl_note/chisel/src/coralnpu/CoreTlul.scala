// ============================================================================
// CoreTlul.scala — Core 的 TileLink-UL 总线封装 (RawModule)
//
// 内部实例化 CoreAxi，再通过 Axi2TLUL(host桥)+TLUL2Axi(device桥)双桥接
// 将 AXI 接口适配为 OpenTitan 标准的 TL-UL Host/Device 接口。
// 结构与 CoreAxi 类似，但对外使用 TL-UL 协议而非 AXI。
// ============================================================================
...
/** CoreTlul — CoreAxi + TL-UL 双桥接 (RawModule) */
