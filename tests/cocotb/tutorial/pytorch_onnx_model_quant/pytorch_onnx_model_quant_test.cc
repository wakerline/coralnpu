...
#include "tests/cocotb/tutorial/pytorch_onnx_model_quant/model_abi.h"
#include "tests/cocotb/tutorial/pytorch_onnx_model_quant/tvmgen_default.h"

extern "C" {
#if defined(PYTORCH_ONNX_MODEL_FLOAT)
