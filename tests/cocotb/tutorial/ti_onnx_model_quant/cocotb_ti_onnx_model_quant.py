...
def _load_model_data():
    ...
    spec = importlib.util.spec_from_file_location("ti_onnx_model_quant_data", model_path)
...
def _resolve_elf_and_mode(r):
    base = "coralnpu_hw/tests/cocotb/tutorial/ti_onnx_model_quant"
    candidates = [
        ("quant", "ti_onnx_model_quant_test.elf"),
        ("float", "ti_onnx_model_float_test.elf"),
    ]
...
@cocotb.test()
async def test_ti_onnx_model_quant(dut):
    r = runfiles.Create()
